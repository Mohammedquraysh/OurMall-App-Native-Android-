...
public final class GetCategoriesUseCase_Factory implements Factory<GetCategoriesUseCase> {
  ...
  public GetCategoriesUseCase_Factory(Provider<ProductRepository> repositoryProvider) {
  ...
  public static GetCategoriesUseCase newInstance(ProductRepository repository) {
